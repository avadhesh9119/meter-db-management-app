...
@Table(value = "devices_commands_prepay_logs")
public class DeviceCommandPrepayLogs {
	...
	public DeviceCommandPrepayLogs() {
	}

	public DeviceCommandPrepayLogs(String device_serial_number, String tracking_id, Map<String,String> command_name, String status,
	...
	public String toString() {
		return "DeviceCommandPrepayLogs [device_serial_number=" + device_serial_number + ", tracking_id=" + tracking_id
				...
				+ ", cell_id=" + cell_id + ", batch_id=" + batch_id + ", source=" + source + ", user_id=" + user_id
				+ ", device_type=" + device_type + ", meter_type=" + meter_type + "]";
	}
