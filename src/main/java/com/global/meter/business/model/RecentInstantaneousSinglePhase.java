...
@Table(value = "recent_instantaneous_data_singlephase")
public class RecentInstantaneousSinglePhase implements Serializable {
    ...
    private Integer cumulative_power_on_duration;
    ...
    private Double instant_voltage;
	...
	public RecentInstantaneousSinglePhase() {
	...
	public Integer getCumulative_power_on_duration() {
		return cumulative_power_on_duration;
	}
	public void setCumulative_power_on_duration(Integer cumulative_power_on_duration) {
		this.cumulative_power_on_duration = cumulative_power_on_duration;
	}
	...
	public Double getInstant_voltage() {
		return instant_voltage;
	}
	public void setInstant_voltage(Double instant_voltage) {
		this.instant_voltage = instant_voltage;
	}
	...
	public String toString() {
		return "InstantaneousSinglePhase [device_serial_number=" + device_serial_number + ", tracking_id="
				+ tracking_id + ", active_power_kw=" + active_power_kw + ", apparent_power_kva="
				+ apparent_power_kva + ", cumulative_bill_count=" + cumulative_bill_count
				+ ", cumulative_energy_kvah_export=" + cumulative_energy_kvah_export
				+ ", cumulative_energy_kvah_import=" + cumulative_energy_kvah_import
				+ ", cumulative_energy_kwh_export=" + cumulative_energy_kwh_export
				+ ", cumulative_energy_kwh_import=" + cumulative_energy_kwh_import
				+ ", cumulative_power_on_duration=" + cumulative_power_on_duration + ", cumulative_program_count="
				+ cumulative_program_count + ", cumulative_tamper_count=" + cumulative_tamper_count + ", datetime="
				+ datetime + ", dcu_serial_number=" + dcu_serial_number + ", dt_name=" + dt_name
				+ ", enable_disable_load=" + enable_disable_load + ", feeder_name=" + feeder_name + ", frequency="
				+ frequency + ", instant_voltage=" + instant_voltage + ", load_limit=" + load_limit
				+ ", load_limit_status=" + load_limit_status + ", maximum_demand_kva=" + maximum_demand_kva
				...
				+ ", mdas_datetime=" + mdas_datetime + ", meter_datetime=" + meter_datetime + ", neutral_current="
				+ neutral_current + ", owner_name=" + owner_name + ", phase_current=" + phase_current
				+ ", power_factor=" + power_factor + ", subdevision_name=" + subdevision_name + ", substation_name="
				+ substation_name + "]";
	}

	public RecentInstantaneousSinglePhase(String device_serial_number, String tracking_id, Double active_power_kw,
			Double apparent_power_kva, Integer cumulative_bill_count, Double cumulative_energy_kvah_export,
			Double cumulative_energy_kvah_import, Double cumulative_energy_kwh_export,
			Double cumulative_energy_kwh_import, Integer cumulative_power_on_duration,
			Integer cumulative_program_count, Integer cumulative_tamper_count, Date datetime,
			String dcu_serial_number, String dt_name, Integer enable_disable_load, String feeder_name,
			Double frequency, Double instant_voltage, Integer load_limit, Integer load_limit_status,
			Double maximum_demand_kva, Date maximum_demand_kva_datetime, Double maximum_demand_kw,
			Date maximum_demand_kw_datetime, Date mdas_datetime, Date meter_datetime, Double neutral_current,
			String owner_name, Double phase_current, Double power_factor, String subdevision_name,
