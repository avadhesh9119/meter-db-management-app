...
@Table(value = "daily_load_profile_threephase")
public class DailyLoadProfileThreePhase implements Serializable{
	...
	public DailyLoadProfileThreePhase(String device_serial_number, Date datetime, Double cumulative_energy_kvah_export,
	...
	public String toString() {
		return "DailyLoadProfileThreePhase [device_serial_number=" + device_serial_number + ", datetime=" + datetime
				...
				+ ", maximum_demand_kva_tier8_date=" + maximum_demand_kva_tier8_date + ", cumulative_energy_kvarh_q1="
				+ cumulative_energy_kvarh_q1 + ", cumulative_energy_kvarh_q2=" + cumulative_energy_kvarh_q2
				+ ", cumulative_energy_kvarh_q3=" + cumulative_energy_kvarh_q3 + ", cumulative_energy_kvarh_q4="
				+ cumulative_energy_kvarh_q4 + ", maximum_demand_kw_export=" + maximum_demand_kw_export
				+ ", maximum_demand_kw_export_datetime=" + maximum_demand_kw_export_datetime
				+ ", maximum_demand_kva_export=" + maximum_demand_kva_export + ", maximum_demand_kva_export_date="
				+ maximum_demand_kva_export_date + ", dcu_serial_number=" + dcu_serial_number + ", dt_name=" + dt_name
				+ ", feeder_name=" + feeder_name + ", mdas_datetime=" + mdas_datetime + ", meter_datetime="
				+ meter_datetime + ", owner_name=" + owner_name + ", subdevision_name=" + subdevision_name
				+ ", substation_name=" + substation_name + ", mode_of_comm=" + mode_of_comm + "]";
	}
