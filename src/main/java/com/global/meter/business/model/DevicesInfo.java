...
public class DevicesInfo implements Serializable {
	...
	private Integer profile_capture_period;
	
	public DevicesInfo() {

	}

	public DevicesInfo(String device_serial_number, Set<String> access, String address, String commissioning_status,
			String consumer_name, Date creation_date, String crn, String dcu_serial_number, String description,
			String device_type, String dt_name, String email_id, String feeder_name, String groups,
			Date installation_datetime, String ip_address_main, String ip_address_push, String ip_config,
			String ip_port_main, String ip_port_push, String latitude, String longitude, String meter_type,
			String mios_type, Date modification_date, String owner_name, String phone_number, Double sanction_load,
			String status, String subdevision_name, String substation_name, Date lastdeltalpreaddatetime,
			Date lastdailylpreaddatetime, Date lastbillingreaddatetime, Date lastcommunicationdatetime,
			Date lasteventsreaddatetime, Date lastinstanteousreaddatetime, Date lastconnectdatetime,
			Date lastdisconnectdatetime, String relay_status, Date meter_datetime, Double cumulative_energy_kvah_export,
			Double cumulative_energy_kvah_import, Double cumulative_energy_kwh_export,
			Double cumulative_energy_kwh_import, Double maximum_demand_kva, Date maximum_demand_kva_datetime,
			Double maximum_demand_kw, Date maximum_demand_kw_datetime, Double load_limits,
			Integer cumulative_tamper_count) {
		super();
	...
	public Integer getProfile_capture_period() {
		return profile_capture_period;
	}

	public void setProfile_capture_period(Integer profile_capture_period) {
		this.profile_capture_period = profile_capture_period;
	}

	@Override
	public String toString() {
		return "DevicesInfo [device_serial_number=" + device_serial_number + ", address=" + address
				...
				+ ", mode_of_comm=" + mode_of_comm + ", meter_nic_id=" + meter_nic_id + ", authkey=" + authkey
				+ ", cipheringkey=" + cipheringkey + ", firmwarepwd=" + firmwarepwd + ", highpwd=" + highpwd
				+ ", lowpwd=" + lowpwd + ", profile_capture_period=" + profile_capture_period + "]";
	}
