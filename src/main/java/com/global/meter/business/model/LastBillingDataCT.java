...
@Table(value = "last_billing_data_ct")
public class LastBillingDataCT implements Serializable {
    ...
    public LastBillingDataCT() {
		super();
	}

	public LastBillingDataCT(String device_serial_number, Date billing_datetime, Double cumulative_energy_kvah_export,
	...
	public String toString() {
		return "LastBillingDataCT [device_serial_number=" + device_serial_number + ", billing_datetime="
