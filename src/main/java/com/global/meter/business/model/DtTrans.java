...
@Table(value = "dt_trans")
public class DtTrans {
	...
	public DtTrans(String dt_name, Set<String> access, Date created, String feeder_name, String latitude,
			String longitude, Date modified, String owner_name, String subdevision_name, String substation_name,
			String source, String user_id, String updated_by) {
		super();
	...
	public String toString() {
		return "DtTrans [dt_name=" + dt_name + ", access=" + access + ", created=" + created + ", feeder_name="
				+ feeder_name + ", latitude=" + latitude + ", longitude=" + longitude + ", modified=" + modified
				+ ", owner_name=" + owner_name + ", subdevision_name=" + subdevision_name + ", substation_name="
				+ substation_name + ", source=" + source + ", user_id=" + user_id + ", updated_by=" + updated_by + "]";
	}
