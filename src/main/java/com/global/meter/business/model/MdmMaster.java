...
@Table(value = "mdm_master")
public class MdmMaster implements Serializable {
	...
	public MdmMaster(String mdm_id, String ftp_address, String ftp_login, String ftp_password, boolean is_active,
	...
	public String toString() {
		return "MdmMaster [mdm_id=" + mdm_id + ", ftp_address=" + ftp_address + ", ftp_login=" + ftp_login
