...
import com.global.meter.inventive.mdm.models.InstantaneousCtMdmResponse;
import com.global.meter.inventive.mdm.models.InstantaneousSinglePhaseMdmResponse;
import com.global.meter.inventive.mdm.models.InstantaneousThreePhaseMdmResponse;
...
@Component
public class InstantaneousDataMdmCaster {
	private static final Logger LOG = LoggerFactory.getLogger(FirmwareConfigMdmCaster.class);

	@Autowired
	DateConverter dateConverter;

	public void prepareSinglePhase(String outputList, List<InstantaneousSinglePhaseMdmResponse> ispResponseList, MeterDataVisualizationReq req)
			throws Exception {
		...
		for (InstantaneousSinglePhase ispData : singlePhaseData) {
			InstantaneousSinglePhaseMdmResponse ispResponse = new InstantaneousSinglePhaseMdmResponse();
			...
			ispResponse.setPowerDuration(String.valueOf(ispData.getCumulative_power_on_duration()));
	...
	public void prepareThreePhase(String outputList, List<InstantaneousThreePhaseMdmResponse> ispResponseList, MeterDataVisualizationReq req)
			throws Exception {
		...
		for (InstantaneousThreePhase ispData : threePhaseData) {
			InstantaneousThreePhaseMdmResponse ispResponse = new InstantaneousThreePhaseMdmResponse();
	...
	public void prepareCt(String outputList, List<InstantaneousCtMdmResponse> ispResponseList, MeterDataVisualizationReq req)
			throws Exception {
		...
		for (InstantaneousCt ispData : ctData) {
			InstantaneousCtMdmResponse ispResponse = new InstantaneousCtMdmResponse();
