...
@Component
public class PushEventsDataCaster {
	...
	public void prepareSinglePhase(String outputList, List<PushEventsResponse> ispResponseList, MeterDataVisualizationReq req)
			throws Exception {
		...
		for (PushEventsSinglePhase ispData : singlePhaseData) {
			...
			ispResponse.setEventDesc(ispData.getEvent_data_desc() != null ? ispData.getEvent_data_desc() : req.getReplaceBy());
			ispResponse.setEventVal(ispData.getEvent_data_val() != null ? ispData.getEvent_data_val() : req.getReplaceBy());
