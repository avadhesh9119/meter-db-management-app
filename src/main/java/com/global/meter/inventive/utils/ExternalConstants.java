...
public class ExternalConstants {
	...
	public static class Message{
		...
		public static final String CANCELLED_SUCCESSFULLY = "Cancelled Successfully..";
		public static final String NIC_EXISTS = "Meter Nic Already Exists..";
		public static final String INVALID_MODE_COMM = "Invalid mode of communication";
		public static final String SIM_NO_EXISTS = "Sim no Already Exists..";
		...
		public static final String DECOMMISSIONED_REQUEST = "Decommissioned request send Successfully!!!";
		public static final String PINGED = "Pinged Successfully!!!";
		public static final String DEV_NOT_INSTALLED = "Device Not Installed..";
		public static final String DEV_NOT_APPROVED = "Device Not Approved..";
		...
		public static final String GATEWAY_SERIAL_NUMBER_EXISTS = "Gateway Serial Number Already Exists..";
		public static final String INVALID_BULK_TYPE = "Invalid bulk type";
		public static final String INVALID_USER = "Invalid user name";
		public static final String INVALID_BATCH_ID = "Invalid batch ID";
		public static final String DCU_SERIAL_NO = "dcu serial no";
		public static final String EMPTY_REQUEST_RECEIVED = "Empty request received";
	}
