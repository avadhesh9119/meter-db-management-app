...
@Component
public class DeltaLPDataCaster {
	private static final Logger LOG = LoggerFactory.getLogger(DeltaLPDataCaster.class);
	
	@Autowired
	DateConverter dateConverter;

	public void prepareSinglePhase(String outputList, List<DeltaLPSinglePhaseResponse> ispResponseList, MeterDataVisualizationReq req) throws Exception{
		...
		for (DeltaLoadProfileSinglePhase ispData : singlePhaseData) {
			...
			ispResponse.setIntervalDatetime(ispData.getInterval_datetime() != null ? dateConverter.convertDateToHesString(ispData.getInterval_datetime()) : req.getReplaceBy());
			...
			ispResponse.setAvgCurrent(ispData.getAverage_current() != null ? String.valueOf(ispData.getAverage_current()) : req.getReplaceBy());
			ispResponse.setAvgVoltage(ispData.getAverage_voltage() != null ? String.valueOf(ispData.getAverage_voltage()) : req.getReplaceBy());
			ispResponse.setStatusByte(ispData.getStatus_byte() != null ? String.valueOf(ispData.getStatus_byte()) : req.getReplaceBy());
	...
	public void prepareCT(String outputList, List<DeltaLPCTResponse> ispResponseList, MeterDataVisualizationReq req) throws Exception{
		...
		for (DeltaLoadProfileCT ispData : ctData) {
			...
			ispResponse.setMeterNumber(ispData.getDevice_serial_number() != null ? ispData.getDevice_serial_number() : req.getReplaceBy());
			ispResponse.setIntervalDatetime(ispData.getInterval_datetime() != null ? dateConverter.convertDateToHesString(ispData.getInterval_datetime()) : req.getReplaceBy());
			ispResponse.setKvahExport(ispData.getBlock_energy_kvah_export() != null ? String.valueOf(CommonUtils.decimalFormat(ispData.getBlock_energy_kvah_export())) : req.getReplaceBy());
			ispResponse.setKvahImport(ispData.getBlock_energy_kvah_import() != null ? (String.valueOf(CommonUtils.decimalFormat(ispData.getBlock_energy_kvah_import()))) : req.getReplaceBy());
			ispResponse.setkWhExport(ispData.getBlock_energy_kwh_export() != null ? String.valueOf(CommonUtils.decimalFormat(ispData.getBlock_energy_kwh_export())) : req.getReplaceBy());
			ispResponse.setkWhImport(ispData.getBlock_energy_kwh_import() != null ? String.valueOf(CommonUtils.decimalFormat(ispData.getBlock_energy_kwh_import())) : req.getReplaceBy());
			ispResponse.setPhaseCurrentL1(ispData.getPhase_current_l1() != null ? String.valueOf(CommonUtils.decimalFormat(ispData.getPhase_current_l1())) : req.getReplaceBy());
			ispResponse.setPhaseCurrentL2(ispData.getPhase_current_l2() != null ? String.valueOf(CommonUtils.decimalFormat(ispData.getPhase_current_l2())) : req.getReplaceBy());
			ispResponse.setPhaseCurrentL3(ispData.getPhase_current_l3() != null ? String.valueOf(CommonUtils.decimalFormat(ispData.getPhase_current_l3())) : req.getReplaceBy());
			ispResponse.setPhaseVoltageL1(ispData.getPhase_voltage_l1() != null ? String.valueOf(CommonUtils.decimalFormat(ispData.getPhase_voltage_l1())) : req.getReplaceBy());
			ispResponse.setPhaseVoltageL2(ispData.getPhase_voltage_l2() != null ? String.valueOf(CommonUtils.decimalFormat(ispData.getPhase_voltage_l2())) : req.getReplaceBy());
			ispResponse.setPhaseVoltageL3(ispData.getPhase_voltage_l3() != null ? String.valueOf(CommonUtils.decimalFormat(ispData.getPhase_voltage_l3())) : req.getReplaceBy());
			...
			ispResponse.setStatusByte(ispData.getStatus_byte() != null ? String.valueOf(CommonUtils.decimalFormat(ispData.getStatus_byte())) : req.getReplaceBy());
			ispResponse.setAvgSignalStrength(ispData.getAvg_signal_strength() != null ? String.valueOf(CommonUtils.decimalFormat(ispData.getAvg_signal_strength())) : req.getReplaceBy());
