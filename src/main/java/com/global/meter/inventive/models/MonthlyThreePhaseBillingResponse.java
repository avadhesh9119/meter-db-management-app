...
public class MonthlyThreePhaseBillingResponse {
	...
	private String sysPowerFactorBillingPeriod;
	...
	public String getSysPowerFactorBillingPeriod() {
		return sysPowerFactorBillingPeriod;
	}

	public void setSysPowerFactorBillingPeriod(String sysPowerFactorBillingPeriod) {
		this.sysPowerFactorBillingPeriod = sysPowerFactorBillingPeriod;
	}
