...
@Table(value = "instantaneous_data_threephase")
public class InstantaneousThreePhase  implements Serializable{
	...
	public InstantaneousThreePhase() {
		super();
	}
	
	public InstantaneousThreePhase(String device_serial_number, String tracking_id, Date datetime,
			...
			Date last_billing_datetime, Double load_limits, Integer load_limit_status, Double maximum_demand_kva,
	...
	public String toString() {
		return "InstantaneousThreePhase [device_serial_number=" + device_serial_number + ", tracking_id=" + tracking_id
				...
				+ last_billing_datetime + ", load_limits=" + load_limits + ", load_limit_status=" + load_limit_status
				...
				+ signed_power_factor_b_phase + ", cumm_power_on_duration_in_mins=" + cumm_power_on_duration_in_mins
				+ "]";
	}
