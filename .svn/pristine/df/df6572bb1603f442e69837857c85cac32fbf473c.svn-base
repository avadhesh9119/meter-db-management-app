...
@Table(value = "billing_data_threephase")
public class BillingDataThreePhase implements Serializable{
    ...
    public BillingDataThreePhase() {
		super();
	}

	public BillingDataThreePhase(String device_serial_number, Date billing_datetime,
	...
	public String toString() {
		return "BillingDataThreePhase [device_serial_number=" + device_serial_number + ", billing_datetime="
