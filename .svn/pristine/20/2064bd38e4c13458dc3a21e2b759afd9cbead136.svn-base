...
public class InstantaneousThreePhaseMdmResponse {
	...
	private String powerFailureDuration;
	...
	public String getPowerFailureDuration() {
		return powerFailureDuration;
	}

	public void setPowerFailureDuration(String powerFailureDuration) {
		this.powerFailureDuration = powerFailureDuration;
	}
