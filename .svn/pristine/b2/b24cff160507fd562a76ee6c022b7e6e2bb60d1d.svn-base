...
public class FeedersController {
	...
	public ResponseEntity<Object> addFeeders(@Valid @RequestBody List<FeederDataRequest> feederDataRequests) {
	...
	public ResponseEntity<Object> updateFeeders(@Valid @RequestBody List<FeederDataRequest> feederDataRequests) {
	...
	public ResponseEntity<Object> getFeeder(@Valid @RequestBody FeederDataRequest feederDataRequests) {
	...
	public ResponseEntity<Object> deleteFeeder(@Valid @RequestBody FeederDataRequest feederDataRequests) {
	...
	public ResponseEntity<Object> getFeederList(@Valid @RequestBody FeederDataRequest feederDataRequests) {
	...
	public ResponseEntity<Object> getFeederNameList(@Valid @RequestBody FeederDataRequest feederDataRequests) {
		LOG.info("Request recieved to get feeders list..." + feederDataRequests.getSubdivisionName());
		CommonResponse response = new CommonResponse();
		try {
	...
	@RequestMapping(value = "/getfeedersBySubstation", method = RequestMethod.POST, consumes = "application/json", produces = "application/json")
	public ResponseEntity<Object> getDeviceCommandLogList(
			@Valid @RequestBody FeederDataRequest feederDataRequests) {
