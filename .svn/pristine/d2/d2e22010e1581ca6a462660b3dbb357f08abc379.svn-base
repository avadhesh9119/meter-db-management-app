...
public class BillingSinglePhaseResponse {
	...
	@JsonProperty("Avg Power factor for Billing Period")
	private String avPfBillingPeriod;

	@JsonProperty("Billing Power Off Duration")
	private String billPOffDuration;

	@JsonProperty("Billing Power On Duration")
	private String billPOnDuration;
	...
	public String getAvPfBillingPeriod() {
		return avPfBillingPeriod;
	}

	public void setAvPfBillingPeriod(String avPfBillingPeriod) {
		this.avPfBillingPeriod = avPfBillingPeriod;
	}

	public String getBillPOffDuration() {
		return billPOffDuration;
	}

	public void setBillPOffDuration(String billPOffDuration) {
		this.billPOffDuration = billPOffDuration;
	}

	public String getBillPOnDuration() {
		return billPOnDuration;
	}

	public void setBillPOnDuration(String billPOnDuration) {
		this.billPOnDuration = billPOnDuration;
	}
