...
@Table(value = "last_billing_data_singlephase")
public class LastBillingDataSinglePhase implements Serializable {

	private static final long serialVersionUID = 8192945632235729203L;
	...
	public LastBillingDataSinglePhase() {
		super();
	}

	public LastBillingDataSinglePhase(String device_serial_number, Date billing_datetime,
	...
	public String toString() {
		return "LastBillingDataSinglePhase [device_serial_number=" + device_serial_number + ", billing_datetime="
