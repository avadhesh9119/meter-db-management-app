...
@Table(value = "dcu_master_logs")
public class DcuMasterLogs implements Serializable {
	...
	public DcuMasterLogs() {	
	}
	public DcuMasterLogs(String dcu_serial_number, Date creation_date, String dcu_mac_nic_id, double frequency,
			String manufacturer, String ipv6_address, String sim_no, String network, String latitude, String longitude,
			String remarks, String owner, Date created_datetime, String created_by, String updated_by,
			Date updated_datetime, String deleted_by, Date deleted_datetime) {
		super();
	...
	public String toString() {
		return "DcuMasterLogs [dcu_serial_number=" + dcu_serial_number + ", creation_date=" + creation_date
				+ ", dcu_mac_nic_id=" + dcu_mac_nic_id + ", frequency=" + frequency + ", manufacturer=" + manufacturer
				+ ", ipv6_address=" + ipv6_address + ", sim_no=" + sim_no + ", network=" + network + ", latitude="
				+ latitude + ", longitude=" + longitude + ", remarks=" + remarks + ", created_datetime="
				+ created_datetime + ", created_by=" + created_by + ", updated_by=" + updated_by + ", updated_datetime="
				+ updated_datetime + ", deleted_by=" + deleted_by + ", deleted_datetime=" + deleted_datetime + "]";
	}
