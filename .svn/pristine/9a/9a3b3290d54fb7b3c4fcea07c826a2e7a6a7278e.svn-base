...
@Table(value = "name_plate_logs")
public class NamePlateLogs implements Serializable {
	...
	public NamePlateLogs() {
		
	}
	
	public NamePlateLogs(String device_serial_number, String category, String current_ratings, String device_id,
	...
	public String toString() {
		return "NamePlateLogs [device_serial_number=" + device_serial_number + ", category=" + category
