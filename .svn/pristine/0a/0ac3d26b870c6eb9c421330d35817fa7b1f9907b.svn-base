...
@Table(value = "user_hierarchy_mapping_log")
public class UserHierMappingLog {
	...
	public UserHierMappingLog(int user_id, int mapping_id, int company_id, int created_by, Date created_on,
			String ip_address, Boolean is_active, Boolean is_default, int last_updated_by, Date last_updated_on,
			int level1_id, int level2_id, int level3_id, int level4_id, int level5_id, int level6_id) {
		super();
