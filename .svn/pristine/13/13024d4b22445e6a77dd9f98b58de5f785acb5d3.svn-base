...
@Component
public class MonthlyBillingMdmCaster {
private static final Logger LOG = LoggerFactory.getLogger(MonthlyBillingMdmCaster.class);
	...
	public void prepareSinglePhase(String outputList, List<MonthlyBillingResponse> ispResponseList, MeterDataVisualizationReq req) throws Exception{
		...
		for (LastBillingDataSinglePhase ispData : singlePhaseData) {
			...
			ispResponse.setAvPfBillingPeriod(String.valueOf(ispData.getAverage_power_factor_for_billing_period()));
//			ispResponse.setAvPowerOffPeriod(String.valueOf(ispData.get()));
	...
	public void prepareThreePhase(String outputList, List<MonthlyThreePhaseBillingResponse> ispResponseList, MeterDataVisualizationReq req) throws Exception{
		...
		for (LastBillingDataThreePhase ispData : singlePhaseData) {
			...
			ispResponse.setDeviceSerialNumber(ispData.getDevice_serial_number());
			ispResponse.setBillingDatetime(dateConverter.convertDateToHesString(ispData.getBilling_datetime()));
			ispResponse.setPowerOnDuration(String.valueOf(ispData.getPower_on_duration_mins()));
			ispResponse.setSysPowerFactorBillingPeriod(String.valueOf(ispData.getSystem_power_factor_billing_period()));
//			ispResponse.setAvPowerOffPeriod(String.valueOf(ispData.get()));
			...
			ispResponse.setMeterDatetime(ispData.getMeter_datetime() != null ?
					dateConverter.convertDateToHesString(ispData.getMeter_datetime()): req.getReplaceBy());
	...
	public void prepareCT(String outputList, List<MonthlyCTBillingResponse> ispResponseList, MeterDataVisualizationReq req) throws Exception{
		...
		for (LastBillingDataCT ispData : ctData) {
			...
			ispResponse.setMdkvaTier1(String.valueOf(CommonUtils.decimalFormat(ispData.getMaximum_demand_kva_tier1())));
			...
			ispResponse.setMdkvaTier2(String.valueOf(ispData.getMaximum_demand_kva_tier2()));
			...
			ispResponse.setMdkvaTier3(String.valueOf(CommonUtils.decimalFormat(ispData.getMaximum_demand_kva_tier3())));
			...
			ispResponse.setMdkvaTier4(String.valueOf(ispData.getMaximum_demand_kva_tier4()));
			...
			ispResponse.setMdkvaTier5(String.valueOf(ispData.getMaximum_demand_kva_tier5()));
			...
			ispResponse.setMdkvaTier6(String.valueOf(ispData.getMaximum_demand_kva_tier6()));
			...
			ispResponse.setMdkvaTier7(String.valueOf(ispData.getMaximum_demand_kva_tier7()));
			...
			ispResponse.setMdkvaTier8(String.valueOf(ispData.getMaximum_demand_kva_tier8()));
			...
			ispResponse.setMdkw(String.valueOf(CommonUtils.decimalFormat(ispData.getMaximum_demand_kw())));
