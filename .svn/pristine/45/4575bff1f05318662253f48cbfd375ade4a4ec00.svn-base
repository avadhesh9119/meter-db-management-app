...
@RestController
@RequestMapping(value = "/hes/dts")
public class DtTransMasterController {

	private static final Logger LOG = LoggerFactory.getLogger(DtTransController.class);

	@Autowired
	DtTransMasterService dtService;

	@Autowired
	RestTemplate restTemplate;

	@RequestMapping(value = "/add", method = RequestMethod.POST, consumes = "application/json", produces = "application/json")
	public ResponseEntity<Object> addDtTrans(@Valid @RequestBody List<DtTransMasterDataRequest> dtTransDataRequests) {
	...
	public ResponseEntity<Object> updateDtTrans(
			@Valid @RequestBody List<DtTransMasterDataRequest> dtTransDataRequests) {
	...
	public ResponseEntity<Object> getDtTrans(@Valid @RequestBody DtTransMasterDataRequest dtTransDataRequests) {
	...
	public ResponseEntity<Object> deleteDtTrans(@Valid @RequestBody DtTransMasterDataRequest dtTransDataRequests) {
	...
	public ResponseEntity<Object> getDtTransList(@Valid @RequestBody DtTransMasterDataRequest dtTransDataRequests) {
	...
	public ResponseEntity<Object> getDtTransNameList(@Valid @RequestBody DtTransMasterDataRequest dtTransDataRequests) {
	...
	@RequestMapping(value = "/get-list-by-feeder", method = RequestMethod.POST, consumes = "application/json", produces = "application/json")
	public ResponseEntity<Object> getDtListByFeeder(@Valid @RequestBody DtTransMasterDataRequest dtTransDataRequests) {
	...
	public ResponseEntity<Object> getMeterListByDt(@Valid @RequestBody DtTransMasterDataRequest dtTransDataRequests) {
	...
	public ResponseEntity<Object> getDtListByUtility(@Valid @RequestBody DtTransMasterDataRequest dtTransDataRequests) {
