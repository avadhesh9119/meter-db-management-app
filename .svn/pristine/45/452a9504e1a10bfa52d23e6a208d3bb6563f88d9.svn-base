...
@Component
public class BillingDataMdmCaster {
	private static final Logger LOG = LoggerFactory.getLogger(BillingDataMdmCaster.class);
	...
	public void prepareSinglePhase(String outputList, List<BillingSinglePhaseResponse> ispResponseList, MeterDataVisualizationReq req)
		...
		for (BillingDataSinglePhase ispData : singlePhaseData) {
			...
			ispResponse.setDeviceSerialNumber(ispData.getDevice_serial_number());
	...
	public void prepareThreePhase(String outputList, List<BillingThreePhaseResponse> ispResponseList, MeterDataVisualizationReq req)
		...
		for (BillingDataThreePhase ispData : singlePhaseData) {
			...
			ispResponse.setKwhTier8(ispData.getCumulative_energy_kwh_tier8() != null ? String.valueOf(ispData.getCumulative_energy_kwh_tier8()) : req.getReplaceBy());
			ispResponse.setMdkva(ispData.getMaximum_demand_kva() != null ? String.valueOf(ispData.getMaximum_demand_kva()) : req.getReplaceBy());
			ispResponse.setMdkvaDatetime(dateConverter.convertDateToHesString(ispData.getMaximum_demand_kva_date()));
			...
			ispResponse.setMdkvaTier1Datetime(dateConverter.convertDateToHesString(ispData.getMaximum_demand_kva_tier1_date()));
			...
			ispResponse.setMdkvaTier2Datetime(dateConverter.convertDateToHesString(ispData.getMaximum_demand_kva_tier2_date()));
			...
			ispResponse.setMdkvaTier3Datetime(dateConverter.convertDateToHesString(ispData.getMaximum_demand_kva_tier3_date()));
			...
			ispResponse.setMdkvaTier4Datetime(dateConverter.convertDateToHesString(ispData.getMaximum_demand_kva_tier4_date()));
			...
			ispResponse.setMdkvaTier5Datetime(dateConverter.convertDateToHesString(ispData.getMaximum_demand_kva_tier5_date()));
			...
			ispResponse.setMdkvaTier6Datetime(dateConverter.convertDateToHesString(ispData.getMaximum_demand_kva_tier6_date()));
			...
			ispResponse.setMdkvaTier7Datetime(dateConverter.convertDateToHesString(ispData.getMaximum_demand_kva_tier7_date()));
			...
			ispResponse.setMdkvaTier8Datetime(dateConverter.convertDateToHesString(ispData.getMaximum_demand_kva_tier8_date()));
			ispResponse.setMdkw(ispData.getMaximum_demand_kw() != null ? String.valueOf(ispData.getMaximum_demand_kw()) : req.getReplaceBy());
			...
			ispResponse.setMdkwTier1Datetime(dateConverter.convertDateToHesString(ispData.getMaximum_demand_kw_tier1_date()));
			...
			ispResponse.setMdkwTier2Datetime(dateConverter.convertDateToHesString(ispData.getMaximum_demand_kw_tier2_date()));
			...
			ispResponse.setMdkwTier3Datetime(dateConverter.convertDateToHesString(ispData.getMaximum_demand_kw_tier3_date()));
			...
			ispResponse.setMdkwTier4Datetime(dateConverter.convertDateToHesString(ispData.getMaximum_demand_kw_tier4_date()));
			...
			ispResponse.setMdkwTier5Datetime(dateConverter.convertDateToHesString(ispData.getMaximum_demand_kw_tier5_date()));
			...
			ispResponse.setMdkwTier6Datetime(dateConverter.convertDateToHesString(ispData.getMaximum_demand_kw_tier6_date()));
			...
			ispResponse.setMdkwTier7Datetime(dateConverter.convertDateToHesString(ispData.getMaximum_demand_kw_tier7_date()));
			...
			ispResponse.setMdasDatetime(ispData.getMdas_datetime() != null ? dateConverter.convertDateToHesString(ispData.getMdas_datetime()) : req.getReplaceBy());
			ispResponse.setMeterDatetime(ispData.getMeter_datetime() != null ? dateConverter.convertDateToHesString(ispData.getMeter_datetime()) : req.getReplaceBy());
			ispResponse.setpOnDurationMins(ispData.getPower_on_duration_mins() != null ? String.valueOf(ispData.getPower_on_duration_mins()) : req.getReplaceBy());
