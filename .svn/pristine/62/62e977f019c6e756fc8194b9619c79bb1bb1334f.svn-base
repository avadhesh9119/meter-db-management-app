...
@Table(value = "priority_events")
public class PriorityEvent implements Serializable{
    ...
    private Set<String> high_priority_event_list;
	...
	public Set<String> getHigh_priority_event_list() {
		return high_priority_event_list;
	}
	public void setHigh_priority_event_list(Set<String> high_priority_event_list) {
		this.high_priority_event_list = high_priority_event_list;
	}
	...
	public String toString() {
		return "PriorityEvent [owner_name=" + owner_name + ", created=" + created + ", modified=" + modified
				+ ", source=" + source + ", created_by=" + created_by + ", updated_by=" + updated_by
				+ ", high_priority_event_list=" + high_priority_event_list + ", critical_event_list="
				+ critical_event_list + ", non_critical_event_list=" + non_critical_event_list + "]";
	}
